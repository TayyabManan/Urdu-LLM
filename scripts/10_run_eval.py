...
Saves results to Modal Volume as eval_results.jsonl.

Prerequisites:
    - Adapter at /vol/7b-full-adapter/ on Modal Volume
    - Eval prompts at data/eval/eval_prompts.jsonl (uploaded by this script)

Run with:
    modal run scripts/10_run_eval.py
"""
...
RESULTS_FILE = "/vol/eval/eval_results.jsonl"
